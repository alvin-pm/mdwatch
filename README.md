...
- **인라인 블록 편집** — 블록을 더블클릭해 소스를 즉석 수정(⌘↵ 저장). 그 블록만 국소 치환해 git diff를 해치지 않고, 편집 중 외부(AI) 수정과의 충돌은 안전하게 보존·해결. 상세는 [PROPOSAL-inline-edit.md](docs/PROPOSAL-inline-edit.md).
